...
namespace Up.Bsky.PostBot.Migrations
{
    ...
    [Migration("20230822151006_TrackUsersPostsChannels")]
    partial class TrackUsersPostsChannels
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Up.Bsky.PostBot.Model.BskyUser", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Up.Bsky.PostBot.Model.DiscordChannel", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("BskyUserDiscordChannel", b =>
                {
                    b.HasOne("Up.Bsky.PostBot.Model.DiscordChannel", null)
                        .WithMany()
                        .HasForeignKey("DiscordChannelId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Up.Bsky.PostBot.Model.BskyUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Up.Bsky.PostBot.Model.PostEntry", b =>
                {
                    b.HasOne("Up.Bsky.PostBot.Model.BskyUser", "User")
                        .WithMany("Posts")
