...
namespace Up.Bsky.PostBot.Migrations
{
    ...
    [Migration("20230824103859_TrackUserChannels")]
    partial class TrackUserChannels
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BskyUserDiscordChannel", b =>
                {
                    b.Property<Guid>("TrackedInChannelsId")
                        .HasColumnType("uuid");

                    b.Property<Guid>("TrackedUsersId")
                        .HasColumnType("uuid");

                    b.HasKey("TrackedInChannelsId", "TrackedUsersId");
            ...
            modelBuilder.Entity("BskyUserDiscordChannel", b =>
                {
                    b.HasOne("Up.Bsky.PostBot.Model.Discord.DiscordChannel", null)
                        .WithMany()
                        .HasForeignKey("TrackedInChannelsId")
